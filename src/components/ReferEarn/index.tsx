...
export const ReferEarn: React.FC<ReferEarnProps> = ({
  ...
  // Dynamic logo image
  const logoSrc =
    "https://images.marketamerica.com/creative/2023/shop-pq4921-core3-health-campaign/usa/lp/c3-primary-logo-white-health.svg?v=1";
  ...
  return (
    <div className="qa-refer-earn oc-re-container">
      ...
      <div className="oc-re-text-container">
        <div className="oc-re-text-box-container">
          ...
          <SocialShareButtons contentStrings={contentStrings} portalId={portalId} creditUser={creditUser}/>
        </div>
